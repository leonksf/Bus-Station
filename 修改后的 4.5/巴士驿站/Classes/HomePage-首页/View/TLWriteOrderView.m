...
-(instancetype)initWithFrame:(CGRect)frame{
    if (self=[super initWithFrame:frame]) {
        ...
        self.time = [self creatLabel:self.time str:@"7月20日" textAlignment:NSTextAlignmentCenter];
        self.time.font=[UIFont systemFontOfSize:15];
        self.date = [self creatLabel:self.date str:@"星期一" textAlignment:NSTextAlignmentCenter];
        ...
        [self.priceLabel mas_makeConstraints:^(MASConstraintMaker *make) {
            ...
            make.bottom.equalTo(self.leftTicket.mas_bottom);
        }];
    }
    return self;
}
